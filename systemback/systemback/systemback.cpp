 ...
 *              2021-2024, MaranBr <maranbr@outlook.com>
 *
...
void systemback::systemcopy()
{
...

    {
        ...
        if(sb::isfile(cfpath))
        {
            ...
            while(! file.atEnd())
            {
                ...
                {
                    if(intrrpt || ! sb::crtfile("/.sbsystemcopy/etc/mtab")) return err();
                    break;
                }
            }
        }
...

    {
        ...
        if(sb::exec("chroot /.sbsystemcopy update-initramfs -tck all")) return err();
    }
